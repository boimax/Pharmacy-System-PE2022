...
function uploadImageToS3(image_path) {
     ...
     <div class="header">
                ...
                <div class="staff-main">
                    <div class="left-side">
                        <div class="form">
                            ...
                            <div class="element">
                                ...
                                <input type="file" name="images" id="images" onchange='loadImage(event)'>
                            </div>
                    ...
                    <div class="right-side">
                        <h3>Employees: &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &nbsp; birthday: &emsp; &emsp; &emsp; &emsp;  userID:</h3>
                        <ul class="employees">
                            <li class="employee">
                                <div class="info">
                                    <img class="avatar" src="./images/duck-img.jpg" alt="avatar">
                                    <p class="name">Minh Duc</p>
                                </div>
                                <p class="birthday">10/10/2001</p>
                                <p class="user-id">10010</p>
...
`;
	employeeEl.querySelector(".avatar").src = imgSrc;
...
function deleteEmployeeHandler(e) {
	...
	console.log("🚀 -> employeeEl", employeeEl);
